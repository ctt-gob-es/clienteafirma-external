...
public class PolylineShape implements Shape {
	 ...
	 */
	@Override
	public boolean contains(final double x, final double y) { return false; }
	 ...
	 */
	@Override
	public boolean contains(final Point2D p) { return false; }
	 ...
	 */
	@Override
	public boolean contains(final double x, final double y, final double w, final double h) { return false; }
	 ...
	 */
	@Override
	public boolean contains(final Rectangle2D r) { return false; }
